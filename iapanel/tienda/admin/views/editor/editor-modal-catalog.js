...
(function(window) {
  ...
  const AVANZADOS = ['galeria', 'imagen', 'caracteristicas', 'cita', 'testimonios', 'faq', 'logos', 'categorias_destacadas', 'producto_destacado', 'contenedor', 'franja', 'espacio', 'formulario', 'video'].map(toCard);
  ...
  function open(onPick, allowedTipos) {
    ...
    if (filtered) {
      ...
      }, 'Mas opciones (galeria, imagen, caracteristicas, cita, testimonios, faq, logos, categorias destacadas, producto destacado, contenedor, franja, espacio, formulario, video)');
    }
