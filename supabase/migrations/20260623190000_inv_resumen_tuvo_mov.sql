-- ============================================================================
-- INVENTARIO — inventario_resumen += tuvo_entrada / tuvo_salida (aditivo).
--  Para el filtro de la lista del Kardex (Nivel 1): "Con entradas" / "Con salidas".
--  tuvo_entrada = hubo movimiento que SUMA mercancía real: tipo 'entrada' o ajuste>0
--                 (NO saldo_inicial; ese es el stock inicial, lo tienen casi todos).
--  tuvo_salida  = hubo movimiento de salida: 'venta' o ajuste<0.
--  Alcance: "alguna vez" (todo el historial, sin ventana). Cambio de return type -> DROP+CREATE.
--  Todo lo demás idéntico a la def viva (20260623170000). Candado intacto.
-- ============================================================================
